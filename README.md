...
현재 수집 범위는 **2022년 7월 1일~2026년 9월 16일**, 회의록 **885건**입니다. 제3대 852건, 제4대 33건이며 가장 최근 회의일은 2026년 9월 9일입니다. 미래 회의록·비공개 자료를 포함한다는 의미가 아닙니다. 원문에 있는 임시회의록·교정 전 안내도 보존합니다.

## 먼저 찾아보기

- [연도별 회의록](indexes/years/README.md): 2022년 141건 · 2023년 223건 · 2024년 216건 · 2025년 208건 · 2026년 97건
...
저장소 링크만 전달했다고 AI가 885건을 모두 읽은 것은 아닙니다. 도구 사용과 파일 접근이 가능한 AI에서는 아래 검색기를 실행하고, 검색 결과의 회의록 본문을 열어 문맥을 확인하게 하세요. 일반 웹 대화에서는 관련 Markdown 파일을 내려받아 첨부할 수 있습니다. 이 저장소 자체는 AI 서비스·로그인·API 키·유료 호출을 제공하지 않습니다.
...
회의일은 문서 메타데이터에 기록합니다. Git 커밋 날짜는 실제 반영 시점이며 회의가 열린 날짜로 소급하지 않습니다. 앞으로 수정된 문서를 반영하면 `git diff`와 `git log`로 변경 내역을 확인할 수 있습니다. 현재는 수집 기준일의 스냅샷으로, 최초 공개부터의 모든 교정 이력을 재구성하지 않았습니다. 자동 최신화 일정은 설정되어 있지 않습니다.
